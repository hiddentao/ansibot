...
_(For Ubuntu users I recommend the [Rowan PPA](https://launchpad.net/~rwky/+archive/ubuntu/nodejs-unstable) for unstable releases. NodeJS 0.11.X+ are still under active development and hence not battle-tested for production )_.
